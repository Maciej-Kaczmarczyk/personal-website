...
const Contact = () => {
  return (
    <div id="contact" className=" overflow-hidden flex justify-center lg:mt-20">
        ...
        <div className="flex flex-col w-full  text-justify gap-3 px-4">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              <label className="text-blue-600 text-xl ml-1" for="fname">
                Name:
              </label>
              <input
                className=" rounded-full py-2 pl-4 duration-200"
                type="text"
                id="fname"
              ></input>
            </div>
            ...
            <div className="flex flex-col gap-1">
              <label className="text-blue-600 text-xl ml-1" for="lname">
                Email:
              </label>
              <input
                className=" rounded-full py-2 pl-4 duration-200"
            ...
            <div className="flex flex-col gap-1">
              ...
              <textarea
                className=" rounded-3xl py-3 pl-4"
                type="text"
                id="message"
              ></textarea>
            </div>
