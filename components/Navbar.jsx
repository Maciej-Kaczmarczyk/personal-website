    ...
    <div ref={animate} className="md:bg-blue-600 z-10 sticky top-0">
      <div className="flex justify-end md:justify-center py-5">
        <div className="md:hidden" onClick={() => {toggleNavbar(); disablePageScroll()}}>
          <svg
            ...
            strokeWidth="1.8"
            stroke="currentColor"
            className="w-8 h-fit mr-4 text-white"
          >
            <path
              strokeLinecap="round"
              ...
              <li className="hover:text-blue-300 hover:cursor-pointer transition-all">
                ...
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    className="w-8 h-fit text-white duration-200 ease-in-out hover:text-blue-300 hover:cursor-pointer"
                    viewBox="0 0 30 30"
                  >
      ...
      {navbar ? (
        <div className="md:hidden flex flex-col bg-blue-700 w-full h-[100vh] absolute top-0 overflow-hidden">
          ...
          <Image
            className="absolute top-[500px] -left-[60%] w-40 opacity-80 animate-slideRight2 pointer-events-none"
            src={cloud1}
            alt="cloud background"
          />
          <Image
            className="absolute top-10 -left-[115%] w-40 opacity-75 animate-slideRight2 pointer-events-none"
            src={cloud1}
            alt="cloud background"
          />
          <Image
            className="absolute top-40 -left-[100%] w-56 opacity-75 animate-slideRight3 pointer-events-none"
            src={cloud1}
            alt="cloud background"
          />
          <Image
            className="absolute top-[350px] -left-[200%] w-64 opacity-75 animate-slideRight1 pointer-events-none"
            src={cloud1}
            alt="cloud background"
          />
        </div>
